...
export default class StartRoom {
    constructor(base) {
        ...
        // reflectFloorVertexShader = reflectFloorVertexShader.replace(/#include<(.*)>/g, (match, p1) => {
        //     return Three.ShaderChunk[p1] || ''
        // })

        // reflectFloorFragmentShader = reflectFloorFragmentShader.replace(/#include<(.*)>/g, (match, p1) => {
        //     return Three.ShaderChunk[p1] || ''
        // })
